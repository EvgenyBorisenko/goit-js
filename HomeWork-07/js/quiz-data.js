export default {
  ...
  questions: [
    {
      question: ' 1. Что возвращает метод Array.prototype.filter()?',
      choices: [
    ...
    {
      question: ' 2. Как получить список всех ключей объекта obj?',
      choices: [
        'obj.keys()',
        'Object.keys(obj)',
        'obj.keys',
    ...
    {
      question: ' 3. Что такое статическое свойство класса?',
      choices: [
    ...
    {
      question: ' 4. Что такое обещание (promise)?',
      choices: [
    ...
    {
      question: ' 5. Выберите не существующий HTTP-метод.',
      choices: ['put', 'get', 'grab', 'delete', 'patch'],
      answer: 2,
    },
    {
      question: ' 6. Какой командой будет запускаться npm-скрипт с именем server?',
      choices: [
        'npm server',
        'npm start server',
        'npm execute server',
